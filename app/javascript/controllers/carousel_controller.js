...
export default class extends Controller {
  ...
  get next() {
    return this.slideTargets.find(
      (slide) => +slide.dataset.index === this.nextValue
    )
  }

  get previous() {
    return this.slideTargets.find(
      (slide) => +slide.dataset.index === this.previousValue
    )
  }

  get current() {
    return this.slideTargets.find(
      (slide) => +slide.dataset.index === this.currentValue
    )
  }
}
